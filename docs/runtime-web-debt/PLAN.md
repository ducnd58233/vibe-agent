...
**Checkpoint:** human approves error fragment shape for HTMX partials.
...
**Checkpoint:** manual browser check on file picker and workspace switcher.
...
**Checkpoint:** `make check` plus existing view tests green without `os.*` in `web/view`.
