...
description: >-
  Applies security discipline for web surfaces, HTTP APIs, document/NoSQL persistence, and LLM tool boundaries (injection, authn/z, secrets, tool abuse). Use for auth changes, untrusted input, webhooks, or data handling.
