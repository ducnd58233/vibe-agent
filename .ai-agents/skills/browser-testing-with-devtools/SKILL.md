...
description: >-
  Diagnoses web UI issues with browser DevTools and structured reproduction steps. Use when debugging layout, network, hydration, or performance in the browser.
