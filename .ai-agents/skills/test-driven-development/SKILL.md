...
description: >-
  Drives changes with tests first (unit/component/E2E for web; pytest or equivalent for HTTP APIs). Use when adding behavior, fixing bugs, or preventing regressions in persistence-backed services.
