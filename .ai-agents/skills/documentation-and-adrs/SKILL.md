...
description: >-
  Writes focused docs and Architecture Decision Records for APIs, data flows, and LLM tool boundaries. Use when recording decisions that affect multiple modules or teams.
...
### Document-oriented database (ADR example)
