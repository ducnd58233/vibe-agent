...
Analyze and improve database access across SQL and NoSQL systems, including correctness errors, query performance, index/data-model design, transaction behavior, and operational symptoms.

## Why

Database issues usually require evidence, not guesses. Experts inspect query shape, generated SQL/commands, schema/indexes, explain/profile output, workload frequency, and operational context before changing code or adding indexes.
